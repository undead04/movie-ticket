...
export class Migrations21734267521763 implements MigrationInterface {
    name = 'Migrations21734267521763'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`bill\` ADD \`statusOrder\` int NOT NULL DEFAULT '1'`);
        await queryRunner.query(`ALTER TABLE \`bill\` ADD \`reservation_time\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`bill\` DROP COLUMN \`reservation_time\``);
        await queryRunner.query(`ALTER TABLE \`bill\` DROP COLUMN \`statusOrder\``);
        await queryRunner.query(`ALTER TABLE \`movie\` ADD \`genre\` varchar(255) NULL DEFAULT 'NULL'`);
