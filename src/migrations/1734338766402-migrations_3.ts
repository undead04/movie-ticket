...
export class Migrations31734338766402 implements MigrationInterface {
    name = 'Migrations31734338766402'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`group_role_permission\` DROP COLUMN \`group_role_id\``);
        await queryRunner.query(`ALTER TABLE \`group_role_permission\` DROP COLUMN \`permission_id\``);
        await queryRunner.query(`ALTER TABLE \`group_role_permission\` ADD \`groupRoleId\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`group_role_permission\` ADD \`permissionId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`group_role_permission\` DROP COLUMN \`permissionId\``);
        await queryRunner.query(`ALTER TABLE \`group_role_permission\` DROP COLUMN \`groupRoleId\``);
        await queryRunner.query(`ALTER TABLE \`group_role_permission\` ADD \`permission_id\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`group_role_permission\` ADD \`group_role_id\` int NULL DEFAULT 'NULL'`);
