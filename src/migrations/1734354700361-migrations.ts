...
export class Migrations1734354700361 implements MigrationInterface {
    name = 'Migrations1734354700361'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`bill\` ADD \`paymentMethod\` varchar(255) NOT NULL`);
